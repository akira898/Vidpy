...
if  os.path.exists("projectsActive.txt"):
    with open("projectsActive.txt","r",encoding="utf-8") as projectsInMemory:
...
while not RunIterpreter:
    ...
    if command.startswith("run "):
        ...
        try:
            ...
            with open("projectsActive.txt","a") as projectsInMemory:
                projectsInMemory.write(name+"\n")
